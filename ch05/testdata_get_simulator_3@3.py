...
import numpy as np
from common.simulator_for_train_three_two import five_layer_simulator
...
x_test , t_test_one ,t_test_two ,t_test_three = get_data.run_simulator_test()

np.save('20**3_x_test.npy' , x_test)
""
np.save('20**3_t_test_one.npy' , t_test_one)
np.save('20**3_t_test_two.npy' , t_test_two)
np.save('20**3_t_test_three.npy' , t_test_three)
